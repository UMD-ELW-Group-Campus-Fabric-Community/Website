      ...
      <main className={defaultStyle.main}>
        <div className={styles.subBody}>
          ...
          <p>
            ...
            company. Through the learning experience, students will get to work
            alongside out partners to solve their business needs ranging from
            UX/UI design to information management. These projects are designed
            as culminating learning experience for our undergraduate and
            graduate students to take their first steps into a professional
            working environment.
          </p>
        </div>
        <div className={styles.imageBody}>
          {panels.map((panel, index) => (
            <div key={index} className={styles.imagePanels}
              onClick={() => {
        ...
        <div className={styles.subBody}>
          ...
          <div>
            ...
            <div className={styles.offsetText}>
              ...
              <p className={styles.bar}>
                ...
                programs are managed and provided support to ensure a successful
                project that meets your needs and a good learning experience for
                students. Schedule a meeting with us to share your information
                challenges, and we will determine the appropriate university
                course, instructor, and student team that can develop a product
          ...
          <div>
            ...
            <div className={styles.offsetText}>
              ...
              <p className={styles.bar}>
                Projects with the Experiential Learning Program provide insight
                into student skillsets, work effort, and talent prior to
                graduation because our partners engage directly with student
                teams throughout the semester. Opportunities include attending
                and participating in hosts events such as career fairs and
                mock-interviews, holding site visits, and sharing job postings
                across through our email board.
              </p>
            </div>
          </div>
        </div>
